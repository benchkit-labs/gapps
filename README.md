...
```html
<iframe src="https://gapps.benchkit-labs.com/launcher.html"
...
**Live demo, themed examples, and an interactive URL builder:** [gapps.benchkit-labs.com](https://gapps.benchkit-labs.com/)
...
The live site URL (`gapps.benchkit-labs.com`) always serves the latest `main`, so an embed pointed at it can change when a new version ships. For production, pin to a tagged release through a versioned CDN instead:
